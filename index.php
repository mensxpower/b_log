...
$cloacker->ua_black = 'facebook,Facebot,facebookexternalhit/1.0,proximic,facebookexternalhit/1.1,Python-urllib,python-requests,zgrab/0.x,Wget(linux),facebookexternalhit/1.1 ( http://www.facebook.com/externalhit_uatext.php),curl,gce-spider,yandex.com/bots'; //Список слова через запятую, при наличии которых в UserAgent, юзер будет отправлен на whitepage
